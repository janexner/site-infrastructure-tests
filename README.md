...
While I originally used phantomJS, I changed to HTMLUnit at some point, and now to ChromeDriver. I presume you know how to checkout by Release, so suffice it to say that 1.0 uses phantomJS, 2.0 is HTMLUnit and 3.0 uses ChromeDriver.

The block tracking feature of 2.0 is gone in 3.0, but might come back if I find out how to do it.

Note that the there is a blog article for version 2.0 (HTMLUnit): https://webanalyticsfordevelopers.com/2017/07/18/automated-testing-blocking-tracking/
